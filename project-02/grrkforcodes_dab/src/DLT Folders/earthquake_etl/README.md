...
This folder defines all source code for the 'earthquake_etl' pipeline:
...
* Take a look at the sample under "sample_users_earthquake_etl.py" to get familiar with the syntax.
