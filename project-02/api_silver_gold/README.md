...
This folder defines all source code for the 'api_silver_gold' pipeline:
...
* Take a look at the sample under "sample_users_api_silver_gold.py" to get familiar with the syntax.
